                ...
                <div className='w-[calc(100%-280px)]'>
                    <div className='bg-[#F7F9F9]'>
                        ...
                        <div className='py-5 px-8'>
                           <div>
                                <div className='bg-white rounded-md p-6 flex items-center justify-between mb-3'>
                                    <div className="flex gap-6 items-center">
    
                                         <div className="flex flex-row items-center">
                                            <label className="font-medium text-base leading-6 text-charcoal  mb-2 mr-3">Start time</label>
                                        ...
                                        <div className="flex flex-row items-center">
                                            <label className="font-medium text-base leading-6 text-charcoal mb-2 mr-3">End time</label>
                                            <div className="flex items-center bg-white border border-gray-300 rounded-md p-0 overflow-hidden shadow-sm">
                                                <input 
                                                    type="text"
                                                    defaultValue="00:00" 
                                    ...
                                    <div>
                                        <div className='flex items-center'>
                                            <button className="block sm:inline-block bg-primary text-white border border-primary py-[11px] px-6 rounded-[6px] hover:bg-transparent hover:text-teal-600 font-semibold w-full sm:w-auto mt-[18px] sm:mt-0">Save slot</button>
