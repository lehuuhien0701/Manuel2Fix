...
const TabButtonQuote = ({ tabs, activeTab, handleTabClick }) => {
  return (
    <div className="mb-10 md:flex overflow-x-auto whitespace-nowrap md:overflow-x-visible md:whitespace-nowrap">
      {tabs.map((tab) => (
        <button
  key={tab.id}
...
>
  {tab.label}
      ...
      <button className='mr-3 font-medium px-6 py-2 text-left rounded-full transition-all bg-[#FBF8F4] text-primary flex items-center gap-[10px]'>
